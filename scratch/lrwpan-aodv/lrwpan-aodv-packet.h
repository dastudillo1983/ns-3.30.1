 ...
 */
#ifndef LRWPAN_AODVPACKET_H
#define LRWPAN_AODVPACKET_H
...
* \brief AODV types
*/
class LrWpanTypeHeader : public Header
{
public:
  /**
   * constructor
   ...
   */
  LrWpanTypeHeader (MessageType t = AODVTYPE_RREQ);
   ...
   */
  bool operator== (LrWpanTypeHeader const & o) const;
private:
...
/**
  ...
  */
std::ostream & operator<< (std::ostream & os, LrWpanTypeHeader const & h);
...
* \brief   Route Request (RREQ) Message Format
  ...
  \endverbatim
*/
class LrWpanRreqHeader : public Header
{
public:
  /**
   * constructor
   ...
   */
   LrWpanRreqHeader (uint8_t flags = 0, uint8_t reserved = 0, uint8_t hopCount = 0,
              uint32_t requestID = 0, Mac16Address dst = Mac16Address (),
              uint32_t dstSeqNo = 0, Mac16Address origin = Mac16Address (),
   ...
   */
  bool operator== (LrWpanRreqHeader const & o) const;
private:
  uint8_t        m_flags;          ///< |J|R|G|D|U| bit flags, see RFC
  uint8_t        m_reserved;       ///< Not used (must be 0)
  uint8_t        m_hopCount;       ///< Hop Count
  uint32_t       m_requestID;      ///< RREQ ID
  Mac16Address    m_dst;            ///< Destination IP Address
  uint32_t       m_dstSeqNo;       ///< Destination Sequence Number
  Mac16Address    m_origin;         ///< Originator IP Address
...
/**
  ...
  * \return updated stream
  */
std::ostream & operator<< (std::ostream & os, LrWpanRreqHeader const &);
...
* \brief Route Reply (RREP) Message Format
  ...
  \endverbatim
*/
class LrWpanRrepHeader : public Header
{
public:
  /**
   * constructor
   ...
   */
  LrWpanRrepHeader (uint8_t prefixSize = 0, uint8_t hopCount = 0, Mac16Address dst =
                Mac16Address (), uint32_t dstSeqNo = 0, Mac16Address origin =
                Mac16Address (), Time lifetime = MilliSeconds (0));
  /**
   * \brief Get the type ID.
   * \return the object TypeId
   */
   ...
   */
  void SetHello (Mac16Address src, uint32_t srcSeqNo, Time lifetime);
   ...
   */
  bool operator== (LrWpanRrepHeader const & o) const;
private:
  uint8_t       m_flags;                  ///< A - acknowledgment required flag
  uint8_t       m_prefixSize;         ///< Prefix Size
  uint8_t             m_hopCount;         ///< Hop Count
  Mac16Address   m_dst;              ///< Destination Mac16 Address
  uint32_t      m_dstSeqNo;         ///< Destination Sequence Number
  Mac16Address     m_origin;           ///< Source Mac16 Address
...
/**
  ...
  * \return updated stream
  */
std::ostream & operator<< (std::ostream & os, LrWpanRrepHeader const &);
...
* \brief Route Error (RERR) Message Format
  ...
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |            Unreachable Destination Mac16 Address (1)          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |         Unreachable Destination Sequence Number (1)           |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-|
  | Additional Unreachable Destination Mac16 Addresses (if needed)|
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
public:
   ...
   * \param dst unreachable Mac16 address
   ...
   */
  bool AddUnDestination (Mac16Address dst, uint32_t seqNo);
  /**
   ...
   */
  bool RemoveUnDestination (std::pair<Mac16Address, uint32_t> & un);
  /// Clear header
  void Clear ();
  /**
...
private:
  ...
  std::map<Mac16Address, uint32_t> m_unreachableDstSeqNo;
};
