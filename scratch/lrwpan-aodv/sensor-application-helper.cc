...
SensorApplicationHelper::SensorApplicationHelper (uint8_t protocol, Address address)
{
  m_factory.SetTypeId ("ns3::SensorApplication");
  m_factory.Set ("SAP", UintegerValue (protocol));
  m_factory.Set ("Remote", AddressValue (address));
}

void 
SensorApplicationHelper::SetAttribute (std::string name, const AttributeValue &value)
{
...
int64_t
SensorApplicationHelper::AssignStreams (NodeContainer c, int64_t stream)
{
...
void 
SensorApplicationHelper::SetConstantRate (DataRate dataRate, uint32_t packetSize)
{
