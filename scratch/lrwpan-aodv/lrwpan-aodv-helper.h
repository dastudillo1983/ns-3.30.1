...
#ifndef LRWPAN_AODV_HELPER_H
#define LRWPAN_AODV_HELPER_H
 ...
 */
class LrWpanAodvHelper : public LrWpanRoutingHelper
{
public:
  LrWpanAodvHelper ();

  /**
   * \returns pointer to clone of this LrWpanAodvHelper
   *
   * \internal
   ...
   */
  virtual Ptr<LrWpanRoutingProtocol> Create (Ptr<Node> node) const;
  /**
