 ...
 */
#ifndef SENSOR_SINK_HELPER_H
#define SENSOR_SINK_HELPER_H
 ...
 * on a set of nodes.
 */
class SensorSinkHelper
{
public:
  /**
   * Create a SensorSinkHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  SensorSinkHelper (uint8_t protocol);
