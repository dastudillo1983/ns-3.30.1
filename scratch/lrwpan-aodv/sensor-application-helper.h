 ...
 */
#ifndef SENSOR_APPLICATION_HELPER_H
#define SENSOR_APPLICATION_HELPER_H
...
public:
  /**
   * Create an SensorApplicationHelper to make it easier to work with OnOffApplications
   *
   ...
   *        to.
   */
  SensorApplicationHelper (uint8_t protocol, Address address);
...
#endif /* SENSOR_APPLICATION_HELPER_H */
