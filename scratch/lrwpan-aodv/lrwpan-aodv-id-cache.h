...
#ifndef LRWPAN_AODV_ID_CACHE_H
#define LRWPAN_AODV_ID_CACHE_H
...
public:
   ...
   */
  LrWpanIdCache (Time lifetime) : m_lifetime (lifetime)
  {
  }
  /**
   ...
   */ 
  bool IsDuplicate (Mac16Address addr, uint32_t id);
