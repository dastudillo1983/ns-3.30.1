...
#ifndef LRWPAN_AODV_DPD_H
#define LRWPAN_AODV_DPD_H

#include "lrwpan-aodv-id-cache.h"
 ...
 */
class LrWpanDuplicatePacketDetection
{
public:
  /**
   * Constructor
   ...
   */
  LrWpanDuplicatePacketDetection (Time lifetime) : m_idCache (lifetime)
  {
  }
  /**
   ...
   */
  bool IsDuplicate (Ptr<const Packet> p, const LrWpanMacHeader & header);
  /**
...
private:
  /// Impl
  LrWpanIdCache m_idCache;
};

}
}

#endif /* LRWPAN_AODV_DPD_H */
