...
#ifndef DSDV6_RTABLE_H
#define DSDV6_RTABLE_H
...
public:
  /// c-tor
  RoutingTableEntry (Ptr<NetDevice> dev = 0, Ipv6Address dst = Ipv6Address (), uint32_t m_seqNo = 0,
                     Ipv6InterfaceAddress iface = Ipv6InterfaceAddress (), uint32_t hops = 0, Ipv6Address nextHop = Ipv6Address (),
...
/**
 * \ingroup dsdv6
 * \brief The Routing table used by DSDV6 protocol
 */
class RoutingTable
{
public:
